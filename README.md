About desdeo-vis-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/desdeo-vis-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/industrial-optimization-group/desdeo-vis

Documentation: https://desdeo.readthedocs.io/projects/desdeo-vis/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2850&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/desdeo-vis-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `desdeo-vis` can be installed with `conda`:
...
```
mamba install desdeo-vis
```

It is possible to list all of the versions of `desdeo-vis` available on your platform with `conda`:
...
```
mamba search desdeo-vis --channel conda-forge
```
...
mamba repoquery search desdeo-vis --channel conda-forge

# List packages depending on `desdeo-vis`:
mamba repoquery whoneeds desdeo-vis --channel conda-forge

# List dependencies of `desdeo-vis`:
mamba repoquery depends desdeo-vis --channel conda-forge
```
